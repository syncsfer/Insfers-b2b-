...
import {
  ...
  AlertCircle, Bot, Send, Wallet, LogOut, Coins, Package, LifeBuoy, Scale, BookOpen,
} from 'lucide-react';
  ...
  return (
    <aside className="w-[240px] h-screen bg-sidebar border-r border-border flex flex-col fixed left-0 top-0 z-40">
      ...
      <div className="px-3 py-4 border-t border-border space-y-2">
        <Link href="/developers" className="flex items-center gap-2 px-3 py-1.5 text-[11px] font-medium text-gray-500 hover:text-blue-600 rounded-md hover:bg-blue-50 transition-colors">
          <BookOpen size={13} /> Developer Docs
        </Link>
